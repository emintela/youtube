    ...
    <div className={ sidebar===true ? "sidebar" : "small-sidebar" }>
      <div className='shortcut-links'>
        ...
        <div className={`side-link ${category===24 ? "active" :""}`} onClick={()=>setCategory(24)}>
          <img src={entertainment} alt="" /><p>Entertenianment</p>
        ...
        <div className='subscribed-list'>
          <h3>Subscribed</h3>
            <div className='side-link' onClick={()=>setCategory(0)}>
              <img src={jack} alt="Jack"/><p>Jack Pie</p>
            </div>
            <div className='side-link' onClick={()=>setCategory(0)}>
              <img src={simon} alt="Mr beast"/><p>Mr Beast</p>
            </div>
            <div className='side-link' onClick={()=>setCategory(0)}>
              <img src={tom} alt="justin bieber"/><p>Justin Bieber</p>
            </div>
            <div className='side-link' onClick={()=>setCategory(0)}>
              <img src={megan} alt="cafts"/><p>5-Minute Crafts</p>
            </div>
            <div className='side-link' onClick={()=>setCategory(0)}>
